...
class Sarsa():
    ...
    '''
    def Q_learning_alg_with_approximation(self,initial_location, epsilon = 0.1, learning_rate = 0.001, ord = 5):
...
if __name__ =="__main__":
    ...
    total_rewards, episode_lengths = solver.Q_learning_alg_with_approximation(initial_location = initial_location)
