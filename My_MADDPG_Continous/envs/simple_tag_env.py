...
# class CustomEnv(raw_env):
#     print("raw_env:", raw_env)
#     # def __init__(self, render_mode="None", num_good=1, num_adversaries=3, num_obstacles=0, max_cycles=25, 
#     #              continuous_actions=True): #, _detection_range = 10.0
#     #     super().__init__(render_mode=render_mode, num_good=num_good, num_adversaries=num_adversaries, num_obstacles=num_obstacles, max_cycles=max_cycles, continuous_actions=continuous_actions)
#     def __init__(
#         self,
#         num_good=1,
#         num_adversaries=3,
...
#         self.detection_range = 1 #_detection_range
