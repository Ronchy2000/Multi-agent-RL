...
def main_parameters():
    ...
    parser.add_argument("--episode_num", type = int, default = 15000) # 5000
    parser.add_argument("--episode_length", type = int, default = 30) #50
    parser.add_argument('--learn_interval', type=int, default=100,
                        help='steps interval between learning time')
    parser.add_argument('--random_steps', type=int, default=100, help='random steps before the agent start to learn') #  2e3
